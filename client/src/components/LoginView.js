    ...
    return (
      <React.Fragment>
       <div className="col-sm-6 text-center d-flex justify-content-center align-items-center">
         <div className="box">
          <h1 className="mb-4" id="titleLogin">Log In</h1>
          <form onSubmit={this.handleSubmit} className="inputs d-inline-block text-center" id="form-login"> 
           <input
              type="text"
              name="username"
              value={username}
            ...
            <input
              ...
              className="form-control-lg mb-4"
            ></input>
            <button type="sumbit" className="form-control-lg" id="buttonLogin">Submit</button>
          </form>
          </div>
        </div>
        <div id="f1_container">
          <div id="f1_card" >
            <div className="col-sm-6">
              <img src="/images/pizza.jpg" alt="pizza" width="500" className="rounded-lg mx-auto d-block flip-box-back" id="imagelogin"/>
            </div>
          </div>
        </div>
